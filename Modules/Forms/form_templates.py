...
class FormChildTemplate:
    ...
    def initialize_components(self):
        ...
        self.trv_available.grid(row=1, column=0, columnspan=10, rowspan=7, sticky=W, padx=50, pady=25)
        ...
        frm_aux4.grid(row=1, column=10, pady=25, padx=20, rowspan=3, sticky=NW)
        sep_template = Separator(self.frm_child_list, orient=VERTICAL)
        sep_template.grid(row=0, column=11, sticky=NS, rowspan=9, padx=5)
        ...
        self.trv_list_summary.grid(row=2, column=12, rowspan=9, sticky=NW, padx=50, pady=25)
