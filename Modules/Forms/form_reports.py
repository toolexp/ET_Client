...
class FormChildReport:
    ...
    def initialize_components(self):
        ...
        self.txt_dtype_exp.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_creation_date_exp.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_exec_date_exp.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_finish_date_exp.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_design_exec_sc_egroup.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_design_no_exec_sc_egroup.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_given_patt_sc_egroup.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_design_exec_sc_cgroup.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_design_no_exec_sc_cgroup.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_given_patt_sc_cgroup.config(font=TEXT_FONT, bg=defaultbg)
        ...
        self.txt_desc_prob.config(font=TEXT_FONT, bg=defaultbg)
